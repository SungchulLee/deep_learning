...
parser = argparse.ArgumentParser(description='cifar10_cnn_batchnorm_dropout')
...
parser.add_argument('--batchnorm', type=bool, default=True, metavar='S',
                    help='batchnorm activation (default: False)')
parser.add_argument('--dropout', type=bool, default=True, metavar='S',
